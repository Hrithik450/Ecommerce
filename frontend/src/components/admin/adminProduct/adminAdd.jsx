...
import { createProduct } from "../../../store/slices/admin/adminProduct/adminProductThunks";
...
const AdminAddDetails = () => {
  ...
  const { adminProductLoading } = useSelector((state) => state.adminProduct);
  ...
  return (
    <Container>
      <Header>
        <HeadTitle>Add New Product-</HeadTitle>
      ...
      <FormContainer onSubmit={handleSubmit}>
        ...
        <SubmitButton type="submit">
          {adminProductLoading ? <DotSpinner /> : "Add"}
        </SubmitButton>
      </FormContainer>
    </Container>
  );
